...
export default async function RootLayout({children}:{children:React.ReactNode}){
  ...
  return <html lang={locale}><body><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(org)}}/><Header locale={locale}/><main>{children}</main><Footer/><MobileCtaGuard/><Analytics/></body></html>
}
